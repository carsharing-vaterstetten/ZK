...
// Config override
#define USE_DEFAULT_CONFIG true // Useful for development or mass deployment
...
#define DEFAULT_CONFIG_APN "iot.1nce.net"
#define DEFAULT_CONFIG_GPRS_USER ""
#define DEFAULT_CONFIG_GPRS_PASSWORD ""
#define DEFAULT_CONFIG_SERVER "api.vat.druenert.com"
#define DEFAULT_CONFIG_PORT 80
#define DEFAULT_CONFIG_PASSWORD "S@V=#2wI=I8#x3>^ga#<6:hNj(1@[%2JFhZSbLejJz^P=X-6uZQmRYruNtW(*A"
